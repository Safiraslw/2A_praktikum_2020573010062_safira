...
?>
<div class="d-flex flex-column flex-shrink-0 p-3" style="background-color:#ffc0cb;" style="width: 280px;">
  <ul class="nav nav-pills flex-column mb-auto">

    <li class="nav-item">
      <a href="home" class="nav-link link-dark <?php if ($_GET['s'] == 'home') echo 'active'; ?>" aria-current="page">
    ...
    ?>
      ...
      <li>
        <a href="mhs" class="nav-link link-dark <?php if ($_GET['s'] == 'mhs') echo 'active'; ?>">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi me-2" viewBox="0 0 16 16">
      ...
      <li>
        <a href="barang" class="nav-link link-dark <?php if ($_GET['s'] == 'barang') echo 'active'; ?>">
          <svg class="bi me-2" width="16" height="16">
            <use xlink:href="#grid" />
          </svg>
          Barang
      ...
      <li>
        <a href="datapinjam" class="nav-link link-dark <?php if ($_GET['s'] == 'datapinjam') echo 'active'; ?>">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi me-2 bi-bag-check-fill" viewBox="0 0 16 16">
