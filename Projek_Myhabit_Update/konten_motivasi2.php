...
<div class="d-flex" id="wrapper">
    ...
    <!-- Akhir Header -->
        ...
        <div class="container-fluid">
                <h2>READ THIS! When You Sad </h2>
                
        <div class="col-9">
            <div class="card">
            <h5 class="card-header">You're Amazing</h5>
            <div class="card-body">
            <p class="card-text">
                You're amazing. Everything will be fine. You are enough. Progression over perfection. You can do anything.
            </p>
            </div>
        </div>
        <br>
