    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-6">
                        <form class="mt-4" action="proses/proses_tambah_motivasi.php" method="POST">
                            <div class="mb-3">
 			   ...
 			   <div class="mb-3">
            			<label class="form-label">Categori</label>
            				<select name="kategori" class="form-select"  style="background-color: #A9BA9D">
                				<option value="1">When Feel Tired</option>
                				<option value="2">When Feel Sad</option>
						<option value="3">When Feel Scare</option>
						<option value="4">When Feel Overthinking</option>
            				</select>
      			   </div>
